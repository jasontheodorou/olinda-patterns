...
export function UsePage() {
  return (
    <div className="o-use">
      <header className="o-use__head">
        <h1 className="o-use__title">Use with Claude</h1>
        <p className="o-use__lede">
          Every Olinda pattern comes with a prompt you can paste into Claude Code inside another project.
          Claude will adapt the pattern to your colours, typography, and content.
        </p>
      </header>

      <ol className="o-use__steps">
        <li>
