...
export function AboutPage() {
  return (
    <div className="o-about">
      <header className="o-about__head">
        <h1 className="o-about__title">About Olinda</h1>
      </header>

      <div className="o-about__body">
        <p>
          Olinda is a small pattern library for public-sector design work. It gives designers
