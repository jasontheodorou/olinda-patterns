...
export function UsePage() {
  return (
    <div className="v-use">
      <header className="v-use__head">
        <h1 className="v-use__title">Use with Claude</h1>
        <p className="v-use__lede">
          Every Valencia pattern comes with a prompt you can paste into Claude Code inside another project.
