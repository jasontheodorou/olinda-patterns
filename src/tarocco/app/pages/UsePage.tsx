...
export function UsePage() {
  return (
    <div className="t-use">
      <header className="t-use__head">
        <h1 className="t-use__title">Use with Claude</h1>
        <p className="t-use__lede">
          Every Tarocco pattern comes with a prompt you can paste into Claude Code inside another project.
          Claude will adapt the pattern to your colours, typography, and content.
        </p>
      </header>

      <ol className="t-use__steps">
        <li>
